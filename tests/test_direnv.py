...
def test_direnv_loads_devshell_tools(
    yolo_with_direnv: Callable[..., subprocess.CompletedProcess[str]],
) -> None:
...
def test_direnv_preserves_sandbox_tools(
    yolo_with_direnv: Callable[..., subprocess.CompletedProcess[str]],
) -> None:
...
def test_direnv_inactive_without_host_direnv(
