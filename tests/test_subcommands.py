...
def test_subcommand_invokes_tool(
    yolo_cmd: Callable[..., subprocess.CompletedProcess[str]],
    tool: str,
) -> None:
...
def test_run_no_command_prints_usage(
    yolo_cmd: Callable[..., subprocess.CompletedProcess[str]],
) -> None:
...
def test_invalid_subcommand_prints_usage(
    yolo_cmd: Callable[..., subprocess.CompletedProcess[str]],
) -> None:
